...
Flash-Next v3 checks use an explicit artifact:
...
The converter tests use two experts at the real gate/up/down dimensions and independently check
packed codes, scale addresses and divisor words. They do not regenerate the full source artifact.
