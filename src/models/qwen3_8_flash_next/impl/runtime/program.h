...
#include "models/qwen3_8_flash_next/impl/runtime/logical_kv_store.h"
#include "models/qwen3_8_flash_next/impl/runtime/state_image_store.h"
#include "models/qwen3_8_flash_next/impl/runtime/prefix_identity.h"
#include "models/qwen3_8_flash_next/impl/runtime/resource_projection.h"
...
#include "models/qwen3_8_flash_next/impl/runtime/vision_prefill.h"
...
using PreparedPromptData    = qwen3_8_flash_next::PreparedPromptData;
using RewriteCheckpointKind = qwen3_8_flash_next::RewriteCheckpointKind;
using RewriteCheckpointSpec = qwen3_8_flash_next::RewriteCheckpointSpec;
...
struct PreparedCaptureBacking {
    ...
    qwen3_8_flash_next::detail::ResidentPrefixIdentity prefix_identity;
};

struct PreparedCaptureIdentity {
    std::shared_ptr<const PreparedCaptureBacking> backing;
    qwen3_8_flash_next::PrefixShortlistKey shortlist_key;
    ...
    [[nodiscard]] const qwen3_8_flash_next::detail::ResidentPrefixIdentity*
    prefix_identity() const noexcept {
...
template <>
struct RequestBasePlanImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT> {
    runtime::RequestPlanSummary summary;
    detail::PhysicalDemand root_demand;
    runtime::PrefillWork root_rebuild_work;
    std::uint32_t root_rebuild_tail_begin = 0;
    qwen3_8_flash_next::PreparedContextCache context_cache;
    ops::SamplingConfig sampling;
    std::uint32_t text_kv_page_entitlement    = 0;
    std::uint32_t backend_kv_page_entitlement = 0;
    std::shared_ptr<const qwen3_8_flash_next::VisionControlPlan> vision_control_plan;
    std::optional<qwen3_8_flash_next::RewriteCheckpointSpec> rewrite_checkpoint;
    std::vector<NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::CaptureGroup> capture_groups;
    std::vector<NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::CaptureGroup> shared_candidates;
    qwen3_8_flash_next::detail::PrefixShortlistDigests prefix_digests;
...
struct ResourceCandidateState {
    ...
    NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::ReusePath reuse =
        NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::ReusePath::Root;
    std::uint32_t reuse_base = 0;
    NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::RewriteCheckpointDisposition rewrite_disposition =
        NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::RewriteCheckpointDisposition::DropOptional;
    ...
    std::vector<qwen3_8_flash_next::detail::PressureDecision> pressure_options;
    ...
    std::vector<qwen3_8_flash_next::detail::PressureDecision> shared_pressure_options;
...
template <>
struct AdmissionCandidateImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT> : ResourceCandidateState {
    NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::MtpBridgeMode mtp_bridge =
        NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::MtpBridgeMode::None;
    bool prepare_mtp = false;
    std::optional<NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::VisionPrefillPlan> vision;
    std::vector<NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::CaptureGroup> capture_groups;
    std::vector<NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::CaptureGroup> shared_candidates;
    ops::SamplingConfig sampling;
    std::uint32_t text_kv_page_entitlement    = 0;
...
template <>
struct CapturePressureCandidateImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT> : ResourceCandidateState {};
...
template <>
AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::AdmissionCandidate(
    std::unique_ptr<detail::AdmissionCandidateImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT>> impl) noexcept
    : impl_(std::move(impl)) {}
...
template <>
AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>&
AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::operator=(AdmissionCandidate&&) noexcept =
    default;

template <>
AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::~AdmissionCandidate() = default;

template <>
CapturePressureCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::CapturePressureCandidate(
    std::unique_ptr<detail::CapturePressureCandidateImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT>>
        impl) noexcept
    : impl_(std::move(impl)) {}
...
template <>
CapturePressureCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>&
CapturePressureCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::operator=(
    CapturePressureCandidate&&) noexcept = default;

template <>
CapturePressureCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::~CapturePressureCandidate() = default;

template <>
const runtime::RequestPlanSummary&
AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::summary() const noexcept {
...
AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>::identity_assessment() const noexcept {
...
using AdmissionCandidateImpl = qwen3_8_flash_next::detail::AdmissionCandidateImpl<Variant>;
using CapturePressureCandidateImpl =
    qwen3_8_flash_next::detail::CapturePressureCandidateImpl<Variant>;
using ResourceCandidateState   = qwen3_8_flash_next::detail::ResourceCandidateState;
using RequestBasePlanImpl      = qwen3_8_flash_next::detail::RequestBasePlanImpl<Variant>;
using CapturePressureCandidate = qwen3_8_flash_next::CapturePressureCandidate<Variant>;
...
struct SequenceState {
    ...
    Tensor rewrite_checkpoint_mtp_hidden;
    std::uint32_t lane = 0;
    ...
    std::array<TokenId, qwen3_8_flash_next::kMtpDecodeMaximumDrafts> mtp_drafts{};
...
public:
    struct PressureRecoveryScratch {
        ...
        struct OwnerProjection {
            ...
            const qwen3_8_flash_next::detail::PressureDecision* decision = nullptr;
            runtime::PlanningOwnerId owner;
        };

        struct CheckpointProjection {
            qwen3_8_flash_next::CheckpointSummary checkpoint;
            StateImageHandle state;
            bool survives = true;
        };
        ...
        qwen3_8_flash_next::ContinuationSummary continuation_summary;
    };
    ...
    [[nodiscard]] std::optional<AdmissionCandidate> seal_materialization(
        ...
        std::span<const qwen3_8_flash_next::detail::PressureDecision* const>
            shared_pressure_options);
    ...
    [[nodiscard]] qwen3_8_flash_next::PhysicalUsageSnapshot physical_usage() const noexcept;

    [[nodiscard]] MemorySummary memory_summary() const noexcept;

    void reset_memory_peaks() noexcept;

    friend struct qwen3_8_flash_next::detail::PressurePlanningSessionImpl<Variant>;
    ...
    std::optional<Tensor> mtp_prefill_hidden;
    std::optional<Tensor> flash_decode_ple;
    std::optional<Tensor> flash_ple_records;
    ...
    qwen3_8_flash_next::OrdinaryDecodeEgress* ordinary_host_egress   = nullptr;
...
private:
    ...
    qwen3_8_flash_next::detail::ResidentPrefixIdentity materialization_identity_;
    qwen3_8_flash_next::detail::PrefixShortlistDigests materialization_prefix_digests_;
    ...
    struct ActiveCaptureTransaction {
        ...
        qwen3_8_flash_next::CaptureStatePlacement state_placement =
            qwen3_8_flash_next::CaptureStatePlacement::DeviceFork;
    ...
    [[nodiscard]] qwen3_8_flash_next::CheckpointSummary
    ...
    [[nodiscard]] qwen3_8_flash_next::ContinuationSummary
    continuation_summary(const SequenceState& sequence) const;
    void populate_continuation_summary(const SequenceState& sequence,
                                       qwen3_8_flash_next::ContinuationSummary& summary) const;
    [[nodiscard]] qwen3_8_flash_next::SharedPrefixSummary
    ...
    [[nodiscard]] std::optional<qwen3_8_flash_next::detail::PressureDecision>
    inspect_pressure_option(
        const SequenceState& sequence, detail::PhysicalResources deficit,
        const MaterializationSourceProtection* protection                   = nullptr,
        const qwen3_8_flash_next::TargetKVRequirement* retained_requirement = nullptr,
        std::span<const runtime::CheckpointRef> dropped_checkpoints         = {},
        std::span<const StateImageHandle> released_states                   = {},
        const qwen3_8_flash_next::detail::PressureDecision* current         = nullptr) const;
    [[nodiscard]] std::vector<qwen3_8_flash_next::detail::PressureDecision>
    inspect_pressure_successors(
        const SequenceState& sequence, detail::PhysicalResources residual,
        const MaterializationSourceProtection* protection,
        const qwen3_8_flash_next::detail::PressureDecision* current = nullptr) const;
    [[nodiscard]] std::vector<qwen3_8_flash_next::detail::PressureDecision>
    inspect_shared_pressure_successors(
        const SharedPrefixState& shared, detail::PhysicalResources residual,
        const MaterializationSourceProtection* protection,
        const qwen3_8_flash_next::detail::PressureDecision* current = nullptr) const;
    [[nodiscard]] std::optional<qwen3_8_flash_next::detail::PressureDecision>
    inspect_shared_pressure_option(
        const SharedPrefixState& shared, detail::PhysicalResources deficit,
        const MaterializationSourceProtection* protection           = nullptr,
        const qwen3_8_flash_next::detail::PressureDecision* current = nullptr) const;
    [[nodiscard]] std::vector<qwen3_8_flash_next::detail::PressureDecision>
    inspect_shared_pressure_options(
        const SharedPrefixState& shared, detail::PhysicalResources deficit,
        const MaterializationSourceProtection* protection           = nullptr,
        const qwen3_8_flash_next::detail::PressureDecision* current = nullptr) const;
    [[nodiscard]] qwen3_8_flash_next::detail::PressureDecision
    ...
    pressure_decision_valid(const SequenceState& sequence,
                            const qwen3_8_flash_next::detail::PressureDecision& decision,
    ...
    checkpoint_restore_requirements(const SequenceKVBundle& kv,
                                    const qwen3_8_flash_next::TargetKVRequirement& requirement,
    ...
    void copy_tail(SequenceState& sequence, const Tensor& source,
                   const Tensor* mtp_source = nullptr);
    ...
    void commit_sequence_kv(SequenceState& sequence, std::uint32_t main_tokens,
                            std::uint32_t backend_tokens = 0);
    [[nodiscard]] qwen3_8_flash_next::PagedKVCache* backend_kv_cache() noexcept;
    [[nodiscard]] const qwen3_8_flash_next::PagedKVCache* backend_kv_cache() const noexcept;
    [[nodiscard]] std::uint32_t backend_kv_valid(const SequenceState& sequence) const noexcept;
    [[nodiscard]] qwen3_8_flash_next::PagedKVCacheView
    text_kv_view(const SequenceState& sequence) const;
    [[nodiscard]] qwen3_8_flash_next::PagedKVCacheView
    mtp_kv_view(const SequenceState& sequence) const;
};
...
template <>
struct PressurePlanningSessionImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT> {
    using Core = NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::ProgramImplCore;
    using AdmissionCandidate =
        qwen3_8_flash_next::AdmissionCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>;
    using CapturePressureCandidate =
        qwen3_8_flash_next::CapturePressureCandidate<NINFER_QWEN38_FLASH_NEXT_VARIANT>;
    using AdmissionCandidateImpl =
        qwen3_8_flash_next::detail::AdmissionCandidateImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT>;
    using CapturePressureCandidateImpl =
        qwen3_8_flash_next::detail::CapturePressureCandidateImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT>;
    using CandidateState = qwen3_8_flash_next::detail::ResourceCandidateState;
    using ContinuationHandle =
        qwen3_8_flash_next::ContinuationHandle<NINFER_QWEN38_FLASH_NEXT_VARIANT>;
    using SharedPrefixHandle =
        qwen3_8_flash_next::SharedPrefixHandle<NINFER_QWEN38_FLASH_NEXT_VARIANT>;
    ...
    [[nodiscard]] qwen3_8_flash_next::PressureTargetHandle
    ...
    [[nodiscard]] qwen3_8_flash_next::PressureConstructionCursor
    begin_construction(qwen3_8_flash_next::PressureTargetHandle target, bool restore = false);
    [[nodiscard]] runtime::PressureConstructionStep
    next_construction_option(qwen3_8_flash_next::PressureConstructionCursor& cursor);
    void choose_construction(qwen3_8_flash_next::PressureConstructionCursor& cursor,
                             runtime::PressureConstructionOptionId option);
    [[nodiscard]] std::optional<qwen3_8_flash_next::PressureTargetHandle>
    construction_target(const qwen3_8_flash_next::PressureConstructionCursor& cursor);
    [[nodiscard]] ConstructionSlot&
    construction_slot(const qwen3_8_flash_next::PressureConstructionCursor& cursor);
    ...
    [[nodiscard]] runtime::PressureTargetGuidance guidance(qwen3_8_flash_next::PressureTargetHandle target);
    [[nodiscard]] qwen3_8_flash_next::AssessedPressureTarget<NINFER_QWEN38_FLASH_NEXT_VARIANT> assess(qwen3_8_flash_next::PressureTargetHandle target);
    [[nodiscard]] qwen3_8_flash_next::PreparedPressureExpansion<NINFER_QWEN38_FLASH_NEXT_VARIANT>
    prepare_expansion(qwen3_8_flash_next::PressureTargetHandle parent,
                      std::uint32_t maximum_owners = std::numeric_limits<std::uint32_t>::max());
    [[nodiscard]] qwen3_8_flash_next::PressureExpansionView
    commit_expansion(qwen3_8_flash_next::PreparedPressureExpansion<NINFER_QWEN38_FLASH_NEXT_VARIANT>&& prepared);
    void discard_expansion(qwen3_8_flash_next::PreparedPressureExpansion<NINFER_QWEN38_FLASH_NEXT_VARIANT>&& prepared) noexcept;
    [[nodiscard]] runtime::PrefillWork
    shared_capture_split_prefill_work(const qwen3_8_flash_next::AssessedPressureTarget<NINFER_QWEN38_FLASH_NEXT_VARIANT>& assessed,
                                      const PreparedPromptData& prompt,
                                      std::span<const std::uint32_t> frontiers) const;
    [[nodiscard]] std::optional<AdmissionCandidate> seal(qwen3_8_flash_next::AssessedPressureTarget<NINFER_QWEN38_FLASH_NEXT_VARIANT>&& assessed,
                                                         const PreparedPromptData& prompt,
                                                         runtime::FinalScheduleIntent intent);
    [[nodiscard]] std::optional<CapturePressureCandidate>
    seal_capture(qwen3_8_flash_next::AssessedPressureTarget<NINFER_QWEN38_FLASH_NEXT_VARIANT>&& assessed);

    [[nodiscard]] bool valid(qwen3_8_flash_next::PressureTargetHandle target) const noexcept;
    ...
    std::vector<qwen3_8_flash_next::PressureTargetHandle> committed_children;
...
template <>
class ProgramImpl<NINFER_QWEN38_FLASH_NEXT_VARIANT> final
    : public NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::ProgramImplCore {
public:
    using NINFER_QWEN38_FLASH_NEXT_RUNTIME_NS::ProgramImplCore::ProgramImplCore;
};
