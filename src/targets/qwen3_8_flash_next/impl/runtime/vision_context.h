...
struct VisionItemView {
    ...
    const qwen3_8_flash_next::VisionItemControl* control = nullptr;
};
...
public:
    ...
    workspace_bytes(const qwen3_8_flash_next::VisionItemControl& item);
...
private:
    ...
    qwen3_8_flash_next::PreparedPromptData& prompt_;
