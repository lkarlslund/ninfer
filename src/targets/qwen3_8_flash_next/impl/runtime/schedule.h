...
using qwen3_8_flash_next::PreparedPromptData;
using qwen3_8_flash_next::PromptModality;
...
struct PrefillContext {
    ...
    qwen3_8_flash_next::PagedKVCacheView text_kv;
    ...
    const qwen3_8_flash_next::DFlashDecodeIngress* dflash_host_ingress = nullptr;
};

struct OrdinaryBatchContext {
    ExecutionCore execution;
    const qwen3_8_flash_next::PagedKVCache& text_cache;
    qwen3_8_flash_next::OrdinaryDecodeState& frame;
    const qwen3_8_flash_next::OrdinaryDecodeIngress& host_ingress;
    qwen3_8_flash_next::OrdinaryDecodeEgress& host_egress;
...
struct DFlashBatchContext {
    ...
    const qwen3_8_flash_next::PagedKVCache& text_cache;
    DFlashPersistentState& dflash;
    qwen3_8_flash_next::DFlashDecodeState& frame;
    const qwen3_8_flash_next::DFlashDecodeIngress& host_ingress;
    qwen3_8_flash_next::DFlashDecodeEgress& host_egress;
    Tensor& continuation_hidden_store;
};
