#include "targets/qwen3_8_flash_next/impl/frontend/media_cache.h"
...
namespace ninfer::targets::qwen3_8_flash_next::frontend_internal {
namespace {
...
struct MediaPreprocessCache::Impl {
    ...
    [[nodiscard]] std::shared_ptr<qwen3_8_flash_next::PreparedMediaPayload>
    allocate_payload(std::size_t elements, const PreparationControl& control) {
        ...
        qwen3_8_flash_next::PreparedMediaPayload* payload = nullptr;
        try {
            payload                 = new qwen3_8_flash_next::PreparedMediaPayload();
        ...
        return std::shared_ptr<qwen3_8_flash_next::PreparedMediaPayload>(
            payload,
            [account = std::move(account), bytes](qwen3_8_flash_next::PreparedMediaPayload* value) {
                delete value;
...
std::shared_ptr<qwen3_8_flash_next::PreparedMediaPayload>
